...
// $UpdateQuery = "UPDATE FEEDBACK SET CREW_NO='$_POST[f_no]', P_ID='$_POST[f_start]', FE_GRADE='$_POST[f_destiny]', FE_MESSAGE='$_POST[f_departuretime]' WHERE CREW_NO='$_POST[hidden]'";
...
$DeleteQuery = "DELETE FROM FEEDBACK WHERE CREW_NO='$_POST[hidden]'";
mysql_query($DeleteQuery, $con);
};

// if(isset($_POST['add'])){
// $AddQuery = "INSERT INTO FEEDBACK (F_NO, CREW_NO, CREW_NAME, CREW_OLD, CREW_GENDER) VALUES ('$_POST[f_no]','$_POST[f_start]','$_POST[f_destiny]','$_POST[f_departuretime]', '$_POST[f_timearr]')";
// mysql_query($AddQuery, $con);
// };

// if(isset($_POST['muliga'])){
// $UpdateQuery1 = "UPDATE FEEDBACK SET CREW_NO='$_POST[no]', P_ID='$_POST[start]', FE_GRADE='$_POST[destiny]', FE_MESSAGE='$_POST[departuretime]' WHERE CREW_NO='$_POST[hidden]'";
// mysql_query($UpdateQuery1, $con);
// };

// 插入数据进行更新
if(isset($_POST['thinkpad'])){
$DeleteQuery1 = "DELETE FROM FEEDBACK WHERE CREW_NO='$_POST[hidden]'";
...
echo "<form action=manager_feedback.php method=post>";
...
echo "<form action=manager_feedback.php method=post>";
echo "<tr>";
echo "<td><input type = text name = f_no value=" . $FLIGHT['CREW_NO'] ." </td>";
echo "<td><input type = text name = f_start value=" . $FLIGHT['P_ID']." </td>";
echo "<td><input type = text name = f_destiny value=" . $FLIGHT['FE_GRADE']." </td>";
echo "<td><input type = text name = f_departuretime value='" . $FLIGHT['FE_MESSAGE']."' </td>";
echo "<input type=hidden name=hidden value=" . $FLIGHT['CREW_NO'] . ">";
