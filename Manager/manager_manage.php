...
$UpdateQuery = "UPDATE MANAGE SET D_NAME='$_POST[f_no]', CREW_NO='$_POST[f_start]', MANAGE_SINCE='$_POST[f_destiny]' WHERE CREW_NO='$_POST[hidden]'";
...
$DeleteQuery = "DELETE FROM MANAGE WHERE CREW_NO='$_POST[hidden]'";
mysql_query($DeleteQuery, $con);
};

if(isset($_POST['add'])){
$AddQuery = "INSERT INTO MANAGE (D_NAME, CREW_NO, MANAGE_SINCE) VALUES ('$_POST[f_no]','$_POST[f_start]','$_POST[f_destiny]')";
mysql_query($AddQuery, $con);
};

if(isset($_POST['muliga'])){
$UpdateQuery1 = "UPDATE MANAGE SET D_NAME='$_POST[no]', CREW_NO='$_POST[start]', MANAGE_SINCE='$_POST[destiny]' WHERE CREW_NO='$_POST[hidden]'";
...
$DeleteQuery1 = "DELETE FROM MANAGE WHERE CREW_NO='$_POST[hidden]'";
...
echo "<td>".$FLIGHT['CREW_NO']."</td>";
echo "<td><input type = text name = f_destiny value=" . $FLIGHT['MANAGE_SINCE']." </td>";
